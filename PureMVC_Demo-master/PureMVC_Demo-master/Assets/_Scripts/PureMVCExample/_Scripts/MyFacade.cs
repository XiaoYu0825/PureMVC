...
public class MyFacade : PureMVC.Patterns.Facade {
    ...
    public const string NOWTIME = "nowtime";
    public const string REFRESH_NOWTIME_UI = "refresh_nowtime_ui";
    public const string UPDATE_NOWTIME_DATA = "update_nowtime_data";
    ...
    public void Launch () {
        //通过command命令启动游戏
         SendNotification (MyFacade.NOWTIME);
    ...
    protected override void InitializeController () {
        ...
        RegisterCommand (NOWTIME, typeof (NowTimeCommand));
    ...
    protected override void InitializeModel () {
        ...
        RegisterProxy (new NowTimeDataProxy (NowTimeDataProxy.NAME));

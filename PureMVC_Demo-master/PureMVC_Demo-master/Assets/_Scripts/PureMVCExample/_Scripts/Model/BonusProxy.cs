...
public class BonusProxy : PureMVC.Patterns.Proxy  {
    ...
    //奖励列表
    public List<BonusVO> BonusLists = new List<BonusVO>();

    public new static string NAME = "Bonus";  ///常规写法。
    ...
    public void AddBonus(BonusVO bonus)
    {
    ...
    public void CreateRewardPool(int count)
    {
        for(int i=0;i<count;++i)
        {
            ...
            BonusVO model = new BonusVO(i+1, name, price);
